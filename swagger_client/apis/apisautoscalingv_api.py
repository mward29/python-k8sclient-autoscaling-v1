...
class ApisautoscalingvApi(object):
    ...
    def list_namespaced_horizontal_pod_autoscaler_1(self, namespace, **kwargs):
        """
        list or watch objects of kind HorizontalPodAutoscaler
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_namespaced_horizontal_pod_autoscaler_1(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_namespaced_horizontal_pod_autoscaler_1" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `list_namespaced_horizontal_pod_autoscaler_1`")
    ...
    def watch_namespaced_horizontal_pod_autoscaler_list_2(self, namespace, **kwargs):
        """
        watch individual changes to a list of HorizontalPodAutoscaler
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_horizontal_pod_autoscaler_list_2(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_horizontal_pod_autoscaler_list_2" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_horizontal_pod_autoscaler_list_2`")
